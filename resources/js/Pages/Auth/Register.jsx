    ...
    return (
        <GuestLayout>
            ...
            <div className="mb-6">
                ...
                >
                    <svg className="h-5 w-5" viewBox="0 0 24 24" aria-hidden="true">
                        ...
                        />
                        <path
                            d="M10.8 19.8927L14.3454 22.6381C12.4363 24.0018 9.98177 24.4199 7.74540 23.5472C3.41813 21.8563 1.07267 17.2018 2.76359 12.8745C3.12722 11.9654 3.6545 11.129 4.30904 10.4018L7.1454 13.2381C6.20017 14.4927 6.05452 16.22 6.78174 17.6563C7.50901 19.0927 9.20008 19.729 10.8 19.8927Z"
                            fill="#FBBC05"
                        />
                        <path
                            d="M12.0003 4.74542C14.2548 4.74542 16.2912 5.5636 17.8548 6.90906L21.4912 3.27269C18.9821 0.927242 15.5821 -0.272758 12.0003 0.0908785C6.9821 0.290879 2.58209 3.52724 0.909363 8.18179L4.30936 11.0182C5.23664 7.38183 8.30936 4.74542 12.0003 4.74542Z"
                            fill="#EA4335"
                        />
                    </svg>
            ...
            <div className="mt-8 pt-6 border-t border-gray-100 flex justify-center">
                ...
                >
                    Already have an account? <span className="text-[#1a1a1a] font-bold underline">Log in</span>
                </Link>
            </div>
        </GuestLayout>
    );
