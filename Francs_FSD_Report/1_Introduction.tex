...
\begin{itemize}
    \item \textbf{Backend Framework:} Laravel 12 (PHP 8.2)
    \item \textbf{Frontend Layer:} React 18 with Inertia.js 2.0 (SPA-style navigation)
    \item \textbf{Styling:} Tailwind CSS v3
    \item \textbf{Build Tool:} Vite 7
    \item \textbf{Database:} PostgreSQL
    \item \textbf{Email:} Laravel Mail (SMTP via Gmail)
    \item \textbf{Image Storage:} Cloudinary (via cloudinary-laravel package)
    \item \textbf{Authentication:} Laravel Breeze + Google OAuth (Socialite)
