...
This test confirms that the User-Product-Order relationship is fully functional and the database constraints (foreign keys, total price calculation) are being enforced correctly within the Laravel/PostgreSQL backend.

\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{live_test_evidence.png}
    \caption{Live Manual Verification Result (Order \#7 Created)}
    \label{fig:live_test_evidence}
\end{figure}
