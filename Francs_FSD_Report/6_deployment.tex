...
\centering
\begin{tikzpicture}[
  folder/.style={rectangle, draw, fill=blue!10, font=\small\bfseries, inner sep=3pt, minimum width=3cm, align=left},
  file/.style={rectangle, draw=gray!50, fill=gray!5, font=\scriptsize, inner sep=2pt, minimum width=2.5cm, align=left},
